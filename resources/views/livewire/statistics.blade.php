    ...
    <div class="seccion-numeros relative">
        ...
        <div class="container-num">
            ...
            <div
                ...
                <div class="contador">
                    <h1 class="text-center title-numbers contador_cantidad" id="cont2" data-cantidad-total="{{ $users }}">0
                    </h1>
                    <p class="text-center p">Alumnos registrados</p>
                </div>
                <div class="contador">
                    <h1 class="text-center title-numbers contador_cantidad" id="cont1" data-cantidad-total="{{ $lessons }}">
                        0</h1>
                    <p class="text-center p">Lecciones totales</p>
                </div>

                <div class="contador">
                    <h1 class="text-center title-numbers contador_cantidad" id="cont3"
                        data-cantidad-total="{{ $courses }}">
                    </h1>
